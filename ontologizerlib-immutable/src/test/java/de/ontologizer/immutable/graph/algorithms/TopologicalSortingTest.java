...
public class TopologicalSortingTest {
	...
	public void testStartFromDag() {
		new TopologicalSorting<Integer, ImmutableEdge<Integer>,
				ImmutableDirectedGraph<Integer, ImmutableEdge<Integer>>>().start(dag, visitor);
	...
	public void testStartFromCyclic() {
		new TopologicalSorting<Integer, ImmutableEdge<Integer>,
				ImmutableDirectedGraph<Integer, ImmutableEdge<Integer>>>().start(cyclic, visitor);
	}
